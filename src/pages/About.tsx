    ...
    <div className="w-full relative h-[calc(100dvh-100px)] flex flex-col px-[0.5rem] sm:px-[1rem] md:px-[5rem] xl:px-[5rem] bg-background">
      <section className="w-full h-full flex min-[1001px]:flex-row flex-col space-x-10 gap-[2rem] min-[1714px]:gap-[4rem] items-start px-[1rem] min-[1001px]:pt-[4rem] min-[1714px]:px-[10rem]">
        <div className="min-w-full min-[1001px]:min-w-[300px] min-[1714px]:min-w-[400px] min-[700px]:gap-[2rem] min-[1001px]:min-h-[400px] flex flex-col items-start justify-between">
          <ul className="flex sm:flex-col sm:w-auto w-[90dvw] overflow-x-auto gap-6 sm:gap-4 sm:text-black text-gray-500 dark:text-white text-nowrap mt-4">
            <li
        ...
        <div
          ...
          <section className="w-full flex min-[470px]:flex-row flex-col min-[470px]:items-center items-start gap-5">
            <div className="w-full md:w-[319px]  h-[180px] drop-shadow-lg shadow-primary/30 rounded-3xl relative overflow-hidden flex items-center justify-center">
              <img
            ...
            <span className="md:text-[40px] text-[1.5rem] inline-flex md:block gap-2 md:gap-4 font-[300] md:w-auto md:leading-[50px] min-[470px]:text-left text-left whitespace-nowrap">
              Miriam{" "}
              <span className="font-[600] inline-flex md:block">
                Agyeiwaah Asante
              </span>
            </span>
          </section>
          ...
          <Separator
            ...
            className="bg-gray-100 dark:bg-secondary-foreground/10 mt-12 mb-5 "
          />
          ...
          <Separator
            orientation="horizontal"
            className="bg-gray-100 dark:bg-secondary-foreground/10  mt-4 mb-2 "
          />
          ...
          <section className="w-full">
            {services.map((service, index) => (
              <Link
                key={index}
                to={service.link}
                className="flex items-center hover:bg-gray-400/10 transition-all duration-300 justify-between space-y-4 border-b border-gray-200 dark:border-gray-800 pb-4 gap-1 cursor-pointer">
                ...
                <div className="flex items-center gap-1 space-x-2 m-2">
                  ...
                  <ArrowUpRight className="w-5 h-5 text-sm text-gray-400 dark:text-white" />
                </div>
              </Link>
            ))}
          </section>
