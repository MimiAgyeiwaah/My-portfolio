...
function About() {
   ...
   const toolkit =  ['/assets/Toolkit/Figma.svg', '/assets/Toolkit/Photoshop.svg', '/assets/Toolkit/Canva.svg', '/assets/Toolkit/Sketch.svg', '/assets/Toolkit/Mobbin.svg', '/assets/Toolkit/Notion.svg', '/assets/Toolkit/Slack.svg', '/assets/Toolkit/Trello.svg', '/assets/Toolkit/HTML5.svg', '/assets/Toolkit/CSS3.svg', '/assets/Toolkit/JavaScript.svg']
    ...
    return (
        <div className='w-full h-[calc(100dvh-100px)] flex flex-col px-[0.5rem] sm:px-[1rem] md:px-[5rem] xl:px-[10rem] bg-white'>
            <section className="w-full h-full flex min-[1001px]:flex-row flex-col gap-[2rem] min-[1714px]:gap-[4rem] items-start px-[1rem] min-[1001px]:pt-[4rem] min-[1714px]:px-[10rem]">
                ...
                <div className="w-full flex-1 overflow-y-auto h-full flex flex-col items-start gap-8">
                    <section className="w-full flex min-[470px]:flex-row flex-col items-center gap-5">
                        <div className="w-full min-[400px]:w-[319px] h-[180px] rounded-3xl relative overflow-hidden flex items-center justify-center">
                            <img src={'assets/profilePicture.svg'} alt="" className="w-full object-contain absolute top-0 left-0 " />
                        </div>
