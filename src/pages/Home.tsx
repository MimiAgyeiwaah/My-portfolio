        ...
        <section className="w-full min-[650px]:min-h-[500px] py-[2rem] min-[650px]:py-[6rem] gap-[2rem] flex flex-col items-center justify-between">
          <div className="flex flex-col items-center gap-1 text-center font-[600]">
            <span className="text-[30px] min-[650px]:text-[44px] flex items-center text-gray-500">
              Hello, I'm
              <span>
                <img src={"assets/logo2.svg"} alt="logo2" className="w-16" />
              </span>
              Mimi
            </span>
            <p className="text-[15px] min-[450px]:text-[30px] min-[650px]:text-[44px] min-[910px]:w-[900px] leading-[1.5rem] min-[450px]:leading-[2.5rem] min-[650px]:leading-[3rem]">
              UI/UX & Graphic Designer creating seamless and visually stunning
              experiences
            </p>
          </div>
          <div className="w-full flex flex-wrap items-center justify-center gap-4">
            ...
            <Button
              variant={"link"}
              asChild
              className="hover:no-underline p-5"
            >
              <Link
                to="/"
        ...
        <section className="w-full py-[4rem] flex md:flex-row flex-col items-center md:gap-[3rem] px-[0.5rem] sm:px-[1rem] md:px-[5rem] lg:px-[10rem] 2xl:px-[20rem]">
          ...
          <div className="w-full flex flex-col items-center md:items-start py-6 gap-4 md:text-left text-center">
            ...
            <p className="md:text-[30px] lg:text-[40px] lg:leading-[50px] font-[200]">
              ...
              experiences. Beyond design, I'm someone who values purpose,
              growth, and authenticity in everything I do.
            </p>
        ...
        <section className="w-full md:min-h-[100dvh] py-[4rem] md:py-[8rem] px-[0.5rem] flex flex-col items-center gap-[2rem] sm:gap-[5rem] bg-primary-foreground">
          <div className="w-fit flex flex-col gap-1 items-center">
            ...
            <p className="md:w-[600px] text-center text-gray-700 text-sm sm:text-base md:text-[18px] mt-3">
              Here’s what clients and collaborators have to say about working
              with me.
            </p>
          </div>
