      ...
      <section className="w-full h-full flex min-[1001px]:flex-row flex-col gap-[1rem] min-[1714px]:gap-[4rem] items-start px-[1rem] min-[1001px]:pt-[4rem] min-[1714px]:px-[10rem]">
          ...
          <div className="w-full gap-3 flex min-[400px]:flex-row flex-col items-start  justify-between sm:text-base text-sm mt-8 md:mt-24">
            <div className="flex flex-col items-start gap-1 min-[700px]:gap-6">
              ...
              {project?.service.map((service, idx) => (
                <p className="max-w-[150px]" key={idx}>
                  {service}
                </p>
              ))}
            </div>
            <div className="hidden min-[400px]:flex flex-col items-start gap-4 sm:gap-6 w-[200px]">
              <p className="text-gray-500 font-200 mb-2 ">ROLE</p>
              <p className="max-w-[150px]">{project?.role}</p>
            </div>
          </div>
        </div>
        <Separator
        ...
        <div className="w-full overflow-y-auto h-full flex flex-col items-start gap-4 md:mx-8 mx-1 scrollbar-hidden scroll-smooth">
          <img
            src={project?.image}
            alt={project?.title}
            className="w-full rounded-3xl h-[475px] object-cover mb-[2rem]"
          />
          ...
          {project?.description.map((desc, idx) => {
            return (
              <div className="w-full flex flex-col items-start gap-4" key={idx}>
                ...
                <p className="text-gray-800 dark:text-gray-500 font-200 text-[18px]">
                  {desc.content}
                </p>
            ...
            {nextProject ? (
              ...
              <a
                ...
                <div className="flex items-center gap-1 space-x-2 m-2">
                  ...
                  <ArrowDownLeft className="w-5 h-5 text-sm text-gray-400" />
                </div>
                <span className="md:text-4xl text-3xl pt-4 m-1 pl-2">
                  {prevProject?.title || ""}
                </span>
