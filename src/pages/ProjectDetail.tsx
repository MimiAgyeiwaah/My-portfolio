        ...
        <div className='w-full h-[calc(100dvh-100px)] flex flex-col px-[0.5rem] sm:px-[1rem] md:px-[5rem] xl:px-[10rem] bg-white'>
            <section className="w-full h-full flex min-[1001px]:flex-row flex-col gap-[2rem] min-[1714px]:gap-[4rem] items-start px-[1rem] min-[1001px]:pt-[4rem] min-[1714px]:px-[10rem]">
                ...
                <div className="w-full flex-1 overflow-y-auto h-full flex flex-col items-start gap-4">
                    <img src={project?.image} alt="" className="w-full rounded-3xl h-[475px] object-cover mb-[2rem]" />
                        ...
                        project?.description.map((desc, idx) => ((
                            <div className="w-full flex flex-col items-start gap-4" key={idx}>
                                ...
                                <section className="w-full flex flex-col gap-[2rem]">
                                    {
                                        desc?.subContent ? desc?.subContent.map((subContent, idx) => ((
                                            <div key={`subcontent-${idx}`} className="w-full flex flex-col gap-[2rem]">
                                                <aside className="flex flex-col gap-[1rem]">
                                                ...
                                                {
                                                    subContent?.image ? <img src={subContent?.image} alt="subcontent" className="w-full h-[300px] object-cover" /> : null
                                                }
                                            </div>
                                        ))) : null
                                    }
                                ...
                                <div className="w-full flex flex-col gap-[2rem]">
                                    {
                                        desc.images?.map((image, idx) => ((
                                            <img src={image} alt="otherimages" className="w-full h-[300px] object-cover" key={`image-${idx}`} />   
                                        )))
                                    }
                                </div>
                            </div>
